...
import { AddHomeworkReducerState } from '@store/addHomework/types'

const initialState: AddHomeworkReducerState = {
	class_study: '',
	homework: '',
	date_for: new Date(),
	date_from: new Date(),
...
export const addHomework = (state = initialState, action: { type: any; payload: any }) => {
	switch (action.type) {
		case CLEAR_ERRORS:
