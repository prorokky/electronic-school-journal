...
import { AddScheduleReducer } from '@store/addSchedule/types'

const initialState: AddScheduleReducer = {
	mondayLessons: '',
	tuesdayLessons: '',
	wednesdayLessons: '',
	thursdayLessons: '',
...
export const addSchedule = (state = initialState, action: { type: any; payload: any }) => {
	switch (action.type) {
